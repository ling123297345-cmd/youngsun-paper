const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./ProductDetail-BT5Dh23t.js","./Products-DFH2CSkA.js","./Industries-DQCd6y6C.js","./Industries-A8ei1avt.css","./PulpMaterials-VOPlXBe9.js","./pulpMaterialsData-TTMci1Aj.js","./PulpArticle-DFEhrKkR.js"])))=>i.map(i=>d[i]);
...
| [NCR carbonless](/products/ncr-paper) | 0.7–0.8 g/cm³ | 22–25 tons | Business forms |
...
- **[C2S Art Paper](/products/c2s-art-board)** — Two-side coated gloss or matt paper for catalogs, magazines, and premium print.
...
Matt-coated surfaces — available in [C2S art matt paper](/products/c2s-art-board) and [label paper](/products/label-paper) — reduce glare while maintaining print quality. They feel more refined, less commercial. Matt surfaces are increasingly preferred in premium sectors because they photograph well (no glare spots) and feel more tactile.
...
- [C2S Art Board — double-side coated for premium print](/products/c2s-art-board)
